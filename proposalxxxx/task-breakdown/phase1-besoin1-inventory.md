...
detailed install guide in `helm-handbook`.
...
inventory table, links to helm-handbook, governance doc, and roadmap.
...
- `CONTRIBUTING.md` — links to helm-handbook CONTRIBUTING.md
